...
const pipelineSteps: PipelineStep[] = [
  ...
  },
  {
    ...
    why: "Instead of searching words, it searches meaning. This is what makes HireStack different from traditional ATS.",
    details: [
  ...
  },
  {
    ...
    why: 'Instead of "Score = 92", HireStack explains WHY.',
    example:
